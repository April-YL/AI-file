...
def run_rollforward_rules(
    ...
    *,
    ...
    issues: list[QcIssue] = []
    issues.extend(recorder.execute_rule("rollforward_exists", check_rollforward_exists, rollforward))
    issues.extend(recorder.execute_rule("rollforward_columns_complete", check_rollforward_columns_complete, rollforward))
    issues.extend(recorder.execute_rule("rollforward_abnormal_amounts", check_rollforward_abnormal_amounts, rollforward))
    issues.extend(
