...
| **K.01 后推** | `K.01 Agree SL to GL` | [k01-six-block-qc-matrix.md](./k01-six-block-qc-matrix.md) | [k01-qc-rules.md](./k01-qc-rules.md) | ✅ 六区块 + L1 | ✅ GL-005/006/007 | ✅ `rollforward_sheet_section` |
...
| `rollforward_fa_list_reconciliation` | K.01 表2/3 ↔ FA list | ⏳ |
...
当前 **已通链路**：汇总 AE-003 + Lead 规则集 + K.01 识别与 P0 + LEAD-010；**未通**：K.01 表2–6 勾稽、K.02/K.03 规则、Notes/TE 闭环。
